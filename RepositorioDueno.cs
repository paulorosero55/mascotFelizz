...
namespace MascotaFeliz.App.Persistencia
{
    public class RepositorioDueno : IRepositorioDueno
    {
        ...
        public Dueno AddDueno(Dueno dueno) //crear dueño
        {
        ...
        public void DeleteDueno(int idDueno)  //borrar dueño
        {
       ...
       public IEnumerable<Dueno> GetAllDuenos()  //consultar todos los dueños
        {
            return GetAllDuenos_();
        }

        public IEnumerable<Dueno> GetDuenosPorFiltro(string filtro) //consultar dueño por filtro
        {
