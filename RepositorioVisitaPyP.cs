...
namespace MascotaFeliz.App.Persistencia
{
    public class RepositorioVisitaPyP : IRepositorioVisitaPyP
    {
        ...
        public VisitaPyP AddVisitaPyP(VisitaPyP visitaPyP) //crear visita
        {
        ...
        public void DeleteVisitaPyP(int idVisitaPyP)  //borrar visita
        {
       ...
       public IEnumerable<VisitaPyP> GetAllVisitasPyP()  //consultar todos las visitas
        {
            return GetAllVisitasPyP_();
        }

     /*  public IEnumerable<VisitaPyP> GetVisitasPyPPorFiltro(string filtro) //consultar visita por filtro
        {
